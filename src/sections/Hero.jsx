    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: 5 }}>
          {["REACT", "NEXT.JS", "React Native", "Node.js"].map((tag) => (
            <span
              key={tag}
    ...
    <section className="hero-wrap">
      ...
      <div style={{ flex: "1 1 420px" }}>
            ...
            >
              ...
              <span
                ...
                style={{
                  ...
                  top: 0,
                  left: 0,
                  animation: "glitch2 9s infinite 1s",
                  pointerEvents: "none",
                }}
              >
                NIKUNJ
        ...
        <Reveal delay={280}>
          ...
          >
            Frontend Engineer with 1 year of experience building and scaling
            production-grade React applications in a fast-paced insurance-tech
            startup. Strong in JavaScript fundamentals, form-heavy UIs, API
            integration, and owning features end-to-end. Experienced in working
            independently without frontend leadership, handling deployments, and
        ...
        <Reveal delay={330}>
          ...
          >
            <MagBtn variant="red" href="#missions">
              VIEW MISSIONS
            </MagBtn>
            <MagBtn variant="cyan" href="#record">
              FIELD RECORD
            </MagBtn>
            <MagBtn variant="ghost" href="#contact">
              OPEN COMMS
            </MagBtn>
          </div>
        </Reveal>
